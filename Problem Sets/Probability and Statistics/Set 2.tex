...
\item Let $p$ and $q$ be distinct prime numbers, and $n$ a positive integer multiple of $pq$. An integer between $1$ and $n$ (inclusive) is selected at random. Let $A$ be the event that it is not divisible by $p$, and let $B$ be the event that it is not divisible by $q$. Are $A$ and $B$ independent?
